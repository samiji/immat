                            ...
                            <div class="box">
                                ...
                                <div id="collapse4" class="body">
                                    <div class="row">
                                        <?php
                                        if (isset($_GET['id'])) {
                                            mysql_query("delete from immat_marque where id=".$_GET['id']);
                                            
                                            echo '<script>window.location="marque.php";</script>';
                                        }
                                        ?>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-4">
                                                    <select name="marque" class="form-control">
                                                        ...
                                                        if (isset($_GET['marque'])) {
                                                            ?>
                                                            <option value="<?php echo $_GET['marque']; ?>"><?php echo $_GET['marque']; ?></option>
                                                            <?php
                                                        } else {
                                                            ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $sql = mysql_query("select * from immat_marque where marque='" . $ma . "' ")or die(mysql_error());
                                                    while ($data = mysql_fetch_array($sql)) {
                                                        ?>
                                                        <tr>
                                                            <td><?php echo $data['modele']; ?></td>
                                                            <td><a href="marque.php?id=<?php echo $data['id']; ?>&marque=AC" class="btn btn-warning btn-xs">Supprimer</a></td>
                                                        </tr>
                                                        <?php
                                                    }
                                                    ?>
