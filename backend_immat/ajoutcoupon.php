                            ...
                            <div class="box">
                                ...
                                <div id="collapse4" class="body">
                                    <div class="row">
                                        <?php
                                        if (isset($_POST['code'])) {
                                            mysql_query("insert into immat_coupon(code,montant,dt_deb,dt_fin,etat)values('" . addslashes($_POST['code']) . "','" . addslashes($_POST['montant']) . "','" . addslashes($_POST['dtdeb']) . "','" . addslashes($_POST['dtfin']) . "',1);");
