        ...
        <div class="bg-dark dk" id="wrap">
            <div id="top">
                ...
                <header class="head">
                    ...
                    <div class="main-bar">
                        <h3>
                            <i class="fa fa-user"></i>&nbsp; Commandes</h3>
                    </div><!-- /.main-bar -->
                </header><!-- /.head -->
            </div><!-- /#top -->
            <div id="left">
                                ...
                                <div class="box">
                                    ...
                                    <div id="collapse4" class="body">
                                        <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                                            ...
                                            <tbody>
                                                <?php
                                                $sql = mysql_query("select * from immat_user_info_voiture where payer=1");
                                                while ($data = mysql_fetch_array($sql)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $data['ref_cmd']; ?></td>
                                                        <td><?php echo $data['date_add']; ?></td>
                                                        <td><?php echo $data['total']; ?></td>
                                                        <td><a href="detailcmd.php?id=<?php echo $data['id']; ?>" class="btn btn-warning btn-xs">Détail</a></td>
                                                    </tr>
                                                    <?php
                                                }
                                                ?>
