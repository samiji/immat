    ...
    <body class="  ">
        <div class="bg-dark dk" id="wrap">
            <div id="top">
                ...
                <header class="head">
                    ...
                    <div class="main-bar">
                        <h3>
                            <i class="fa fa-user"></i>&nbsp; Prix par région</h3>
                    </div><!-- /.main-bar -->
                </header><!-- /.head -->
            </div><!-- /#top -->
            <div id="left">
                            ...
                            <div class="col-lg-12">
                                <div class="box">
                                    <header>
                                        ...
                                        <h5 style="color: #000">Prix par région</h5>
                                    </header>
                                    <div id="collapse4" class="body" style="color: #000 !important">
                                        <div class="row">
                                            ...
                                            <table style="color:#000" id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $sql = mysql_query("select * from immat_cp_cheval_fiscal");
                                                    while ($data = mysql_fetch_array($sql)) {
                                                        ?>
                                                        <tr>
                                                            <th><?php echo $data['ville']; ?></th>
                                                            <th><input type="text" id="region_<?php echo $data['id']; ?>" value="<?php echo $data['prix']; ?>" /></th>        
        ...
        <script>
            function modifprix(id) {
                var prix = document.getElementById("region_" + id).value;
                $.ajax({
