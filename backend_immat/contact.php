        ...
        <div class="bg-dark dk" id="wrap">
            <div id="top">
                ...
                <header class="head">
                    ...
                    <div class="main-bar">
                        <h3>
                            <i class="fa fa-user"></i>&nbsp; Contacts</h3>
                    </div><!-- /.main-bar -->
                </header><!-- /.head -->
            </div><!-- /#top -->
            <div id="left">
            ...
            <div id="content">
                <div class="outer">
                    <div class="inner bg-light lter">
                        <?php
                        if (isset($_GET['id'])) {
                            mysql_query("delete from immat_contact where id=" . $_GET['id']);
                                ...
                                <div class="box">
                                    ...
                                    <div id="collapse4" class="body">
                                        <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                                            ...
                                            <tbody>
                                                <?php
                                                $sql = mysql_query("select * from immat_contact");
                                                while ($data = mysql_fetch_array($sql)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="contact.php?id=<?php echo $data['id']; ?>" class="btn btn-warning btn-xs">Supprimer</a></td>
                                                    </tr>
                                                    <?php
                                                }
                                                ?>
