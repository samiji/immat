...
class MoneticoPaiement_Ept {
	...
	var $sVersion;	// Version du TPE - EPT Version (Ex : 3.0)
	var $sNumero;	// Numero du TPE - EPT Number (Ex : 1234567)
	...
	var $sUrlPaiement;	// Url du serveur de paiement - Payment Server URL (Ex : https://p.monetico-services.com/paiement.cgi)
	...
	function MoneticoPaiement_Ept($sLangue = "FR") {
	...
	function _checkEptParams($aConstants) {
...
class MoneticoPaiement_Hmac {
	...
	var $_sUsableKey;	// La cl� du TPE en format op�rationnel / The usable EPT key
	...
	function MoneticoPaiement_Hmac($oEpt) {
